...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/purchases/get_customers', 'PurchaseController@getCustomers');
    Route::post('/purchases/get_purchase_entry_row', 'PurchaseController@getPurchaseEntryRow');
    Route::post('/purchases/get_request_entry_row', 'PurchaseController@getRequestEntryRow');
    ...
    Route::get('requests', 'PurchaseController@listRequests')->name('requests');
    Route::get('request/{id}', 'PurchaseController@viewRequests')->name('viewRequests');
    Route::get('request/{id}/edit', 'RequestController@edit')->name('editRequest');
    Route::get('request/{id}/draft/quote/edit', 'RequestController@draftQuoteEdit')->name('draftQuoteEdit');
    Route::post('request/{id}/update', 'RequestController@update')->name('updateRequest');
    Route::get('requests/items', 'PurchaseController@requestitems')->name('request.items');
    Route::get('requests/ready-to-draft', 'RequestController@readyToDraftList')->name('request.readyToDraftList');
    Route::get('request/item/{id}/edit', 'RequestController@editItem')->name('request.item.edit');
    Route::get('request/item/{id}/reject', 'RequestController@rejectItem')->name('request.item.reject');
    Route::post('request/item/{id}/update', 'RequestController@itemUpdate')->name('request.item.update');
    Route::get('request/{id}/edit-readyToDraft', 'RequestController@draftEdit')->name('request.item.draft.edit');
    Route::post('request/{id}/update-readyToDraft', 'RequestController@draftUpdate')->name('request.item.draft.update');
    Route::get('requests/draft', 'RequestController@draftList')->name('request.item.draft.list');
    Route::post('request/{id}/draft-quote/update', 'RequestController@updateDraftquote')->name('request.item.updateDraftquote');
    Route::get('requests/list/quote', 'RequestController@listQuote')->name('request.quote');
    Route::get('request/{id}/quote/accept', 'RequestController@acceptQuote')->name('request.quote.accept');
    Route::post('request/{id}/quote/accept/save', 'RequestController@accepteQuoteForm')->name('request.item.accepteQuoteForm');
    Route::get('request/quote/accepted', 'RequestController@acceptedQuote')->name('request.list.quote.accept');
    Route::get('request/{id}/quote/reject', 'RequestController@rejectQuote')->name('request.quote.reject');
    Route::get('request/{id}/quote/print', 'RequestController@printQuote')->name('request.quote.print');
    Route::get('request/quote/rejected', 'RequestController@listRejected')->name('request.quote.listRejected');
    Route::get('request/quote/disputed', 'RequestController@listDisputed')->name('request.quote.listDisputed');
    Route::get('request/{id}/quote/dispute', 'RequestController@disputedQuote')->name('request.disputedQuote');
    // Route::get('request/item/{id}/reject', 'RequestController@requestItemReject')->name('request.item.reject');
    ...
    // Route::get('requests/pendingPurchaseRequest', 'PurchaseController@pendingPurchaseRequest')->name('requests');
    // Route::get('requests/purchaseOrderListRequest', 'PurchaseController@purchaseOrderListRequest')->name('requests');
    Route::get('purchases/add_requests', 'PurchaseController@addRequest');
    Route::post('purchases/request/storeRequest', 'PurchaseController@storeRequest')->name('request.store');
    ...
    // Route::get('sells/list_requests', 'SellController@listRequests');
    ...
    Route::put('pos/{id}/update', 'SellPosController@update')->name('pos.update');
    ...
    //Reports...
    Route::get('/reports/gst-purchase-report', 'ReportController@gstPurchaseReport');
    Route::get('/reports/gst-sales-report', 'ReportController@gstSalesReport');
    ...
    Route::get('/request/{id}/purchasing-inf-report', 'RequestController@showPurchasingInfReport')
...
Route::get('/add-columns', function () {
    // DB::statement("ALTER TABLE request_items ADD tax INT DEFAULT 0");
