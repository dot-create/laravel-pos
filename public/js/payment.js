...
$(document).on("keyup", ".edit_payment_amount", function() {
  var amountInput = $("#amount");
  var maxValue = parseFloat(amountInput.data("rule-max-value").replace(",",""));

  amountInput.on("input", function() {
    var enteredValue = parseFloat(amountInput.val().replace(/,/g, ""));

    if (enteredValue > maxValue) {
      $("#amount-error").text(amountInput.data("msg-max-value"));
