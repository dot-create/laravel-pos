            ...
            .autocomplete({
                ...
                response: function(event, ui) {
                    if (ui.content.length == 1) {
                        ...
                        var sell_type=$('#status').val();
                        if(sell_type=="draft" || sell_type == "quotation" ){
                            is_overselling_allowed = true;
                        }
...
function pos_product_row(variation_id = null, purchase_line_id = null, weighing_scale_barcode = null, quantity = 1) {
    ...
    if (add_via_ajax) {
        ...
        var sell_type=$('#status').val();
        var is_overselling_allowed=$('#is_overselling_allowed').val();
...
function pos_total_row() {
    ...
    // console.log(__currency_trans_from_en(price_total, false));
