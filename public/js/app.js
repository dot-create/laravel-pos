...
$(document).on('click','.contact-person-delete',function(e){
    // editContact=0;
    e.preventDefault();
...
$(document).on('click','.contact-person-edit',function(e){
    e.preventDefault();
    ...
    $('.btn-add-more-contact').text('Update Contact');
});

function deleteContact(id){

    // Check if ID is empty, null, or 0 (unsaved contact)
    if ( typeof id == 'string' && (id === '' || id === '0' || id === 'undefined') ) {
        $('#contact_person_body tr[data-id="' + id + '"]').remove();
        return;
    }
...
//     var position = $("#representative_position").val();
//     var phone = $("#representative_phone").val();
//     var mobile = $("#representative_mobile").val();
...
//                           <td>${result.contact.representative_position}</td>
//                           <td>${result.contact.representative_phone}</td>
//                           <td>${result.contact.representative_mobile}</td>
...
var contactIndex = 0; // To uniquely name hidden inputs
