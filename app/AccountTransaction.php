...
class AccountTransaction extends Model
{
    ...
    public static function createAccountTransaction($data)
    {
        ...
        //     if($transaction) {
        //         $location = BusinessLocation::find($transaction->id);
        //         $exchange_rate = Currency::where('id', $location->currency_id)->first();
        //         $data['amount'] = str_replace(",", "", $data['amount']) * $exchange_rate->rate;
        //     }
        // }
        $transaction_data = [
            'amount' => $data['amount'],
