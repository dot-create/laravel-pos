...
class PurchaseRequisitionController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($purchase_requisitions)
                ->addColumn('action', function ($row) {
                    ...
                    $html .= '<li><a href="#" data-href="' . action('PurchaseRequisitionController@show', [$row->id]) . '" class="btn-modal" data-container=".view_modal"><i class="fas fa-eye" aria-hidden="true"></i>' . __("messages.view") . '</a></li>';
                    
                    if (auth()->user()->can("purchase_requisition.delete")) {
                        $html .= '<li><a href="' . action('PurchaseRequisitionController@destroy', [$row->id]) . '" class="delete-purchase-requisition"><i class="fas fa-trash"></i>' . __("messages.delete") . '</a></li>';
                    }
                ...
                ->setRowAttr([
                    'data-href' => function ($row) {
                        return  action('PurchaseRequisitionController@show', [$row->id]) ;
                    }])
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('PurchaseRequisitionController@index')->with('status', $output);
    }
    ...
    public function getCurrencyDetails($location_id) {
