...
class BusinessLocationController extends Controller
{
    ...
    public function create()
    {
        ...
        $currencies = Currency::where('business_id', $business_id)
                            ->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input = $request->only(['name', 'landmark', 'city', 'state', 'currency_id', 'country', 'zip_code', 'invoice_scheme_id',
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $input = $request->only(['name', 'landmark', 'city', 'state', 'country',
                ...
                'invoice_layout_id', 'mobile', 'alternate_number', 'email', 'currency_id','website', 'custom_field1', 'custom_field2', 'custom_field3', 'custom_field4', 'location_id', 'selling_price_group_id', 'default_payment_accounts', 'featured_products', 'sale_invoice_layout_id']);
