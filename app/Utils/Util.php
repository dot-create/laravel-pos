...
class Util
{
    ...
    {
        return [
            'Pending' => __('request.pending'),
            'ReadyTodraft' => __('request.ready_to_draft'),
            'Draft' => __('request.draft'),
            'Rejected' => __('request.Rejected'),
            'AcceptedQuote' => __('request.AcceptedQuote'),
            'RejectedQuote' => __('request.RejectedQuote'),
