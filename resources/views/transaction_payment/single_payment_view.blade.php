    ...
    <div class="modal-body">
      ...
      <div class="row">
          ...
          <div class="col-xs-6">
            ...
            {{-- {{ $currency_details->symbol }} {{ number_format($transaction->type == 'expense' ? $single_payment_line->amount : $single_payment_line->amount * $currency_details->rate , 2) }}<br> --}}
            {{ $currency_details->symbol }} {{ number_format($transaction->type == 'expense' ? $single_payment_line->amount : $single_payment_line->amount , 2) }}<br>
