                    ...
                    <div class="table-responsive">
                        ...
                        @forelse ($payments as $payment)
                            <tr>
                              ...
                              <td><span class="display_currency" data-currency_symbol="true" data-currency="{{ $currency_details->symbol }}">{{ $expense ? str_replace(",","", number_format($payment->amount, 2)) : number_format($payment->amount) }}</span></td>
                             {{-- <td><span class="display_currency" data-currency_symbol="true" data-currency="{{ $currency_details->symbol }}">{{ $payment->amount }}</span></td> --}}
