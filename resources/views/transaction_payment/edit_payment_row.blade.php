  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="well">
            {{-- <strong>@lang('sale.total_amount'): </strong><span class="display_currency" data-currency_symbol="true" data-currency="{{ $currency_details->symbol }}">{{ $expense ? str_replace(",","", $transaction->final_total) / $currency_details->rate : str_replace(",","", $transaction->final_total) * $currency_details->rate }}</span><br> --}}
            <strong>@lang('sale.total_amount'): </strong><span class="display_currency" data-currency_symbol="true" data-currency="{{ $currency_details->symbol }}">{{ $expense ? str_replace(",","", $transaction->final_total) : str_replace(",","", $transaction->final_total) }}</span><br>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text("amount", 
                // @num_format($expense ? $payment_line->amount : $payment_line->amount * $currency_details->rate), [
                @num_format($expense ? $payment_line->amount : $payment_line->amount ), [
                    'class' => 'form-control input_number edit_payment_amount', 
                    'required', 
                    'placeholder' => 'Amount',
