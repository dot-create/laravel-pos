    ...
    @component('components.filters', ['title' => __('report.filters')])
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::text('purchase_list_filter_date_range', null, ['placeholder' => __('lang_v1.select_a_date_range'), 'class' => 'form-control']); !!}
            </div>
        </div>
    @endcomponent

    @component('components.widget', ['class' => 'box-primary', 'title' => __('request.all_requests')])
        <table class="table table-bordered table-striped ajax_view" id="pending_request_items_table" style="width: 100%;">
            <thead>
                <tr>
                    <th>Date</th>
                    <th>@lang('request.ref_no')</th>
                    <th>@lang('request.product_name')</th>
                    <th>@lang('request.product_type')</th>
                    <th>@lang('request.product_sku')</th>
