		...
		<div class="col-md-12 col-sm-12">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					{!!Form::text('shipping_charges',@num_format($transaction->shipping_charges* $currency_details->rate),['class'=>'form-control input_number','placeholder'=> __('sale.shipping_charges')]);!!}
					</div>
				</div>
			</div>
			<div class="clearfix"></div>
