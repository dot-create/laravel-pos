				...
				<div class="@if(empty($pos_settings['hide_product_suggestion'])) col-md-6 @else col-md-10 col-md-offset-1 @endif no-padding pr-12">
					...
					<div class="col-md-2" >
						<div class="row" style="border: 5px solid; border-color: #001f3f; margin-bottom: 5px;max-height: 500px;
							overflow-y: scroll;
							overflow-x: hidden;">
							<div class="col-xs-6 offset-xs-0 col-md-12  text-center" style="margin-top: 5px;">
								<div class="btn btn-success product_category_block" data-value="all">
									@lang('lang_v1.all_category')
								</div>
							</div>
							@foreach($categories as $category)
								<div class="col-xs-6 offset-xs-0 col-md-12  text-center" style="margin-top: 5px; margin-bottom: 5px">
									<div class="btn btn-primary product_category_block" data-value="{{$category['id']}}" style="width: 114px;">
									{{\Illuminate\Support\Str::limit(ucfirst($category['name']),12)}}
									</div>
								</div>
							@endforeach
						</div>
