...
<div class="row">
	...
	@if($receipt_details->show_qr_code && !empty($receipt_details->qr_code_text))
		<img class="center-block" src="data:image/png;base64,{{DNS2D::getBarcodePNG($receipt_details->qr_code_text, 'QRCODE', 2, 2, [39, 48, 54])}}" >
	@endif
				...
				<tr>
					...
					@if(!empty($receipt_details->item_discount_label))
						<td class="text-right">
							...
							{{$line['line_discount'] ? $line['line_discount'] : '0.00'}}
						</td>
					@endif
			...
			<table class="table table-slim">
				...
				@if( !empty($receipt_details->total_line_discount) )
					<tr>
						...
						<td class="text-right">
							{{format_currency($receipt_details->foreign_total_line_discount* $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol)}}
						</td>
					</tr>
				@endif
				...
				@if(!empty($receipt_details->taxes))
					<tr>
						...
						<td class="text-right">
							{{format_currency($receipt_details->foreign_subtotal_exc_tax * $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol )}}
						</td>
					</tr>
					@foreach($receipt_details->foreign_taxes as $k => $v)
						@if($k !== 'Total Tax')
							<tr>
								<th style="width:70%">
									{{$k}}
								...
								<td class="text-right">
									{{format_currency($v * $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol )}}
								</td>
							</tr>
						@endif
					@endforeach
				@else
					<tr>
						...
						<td class="text-right">
							{{format_currency($receipt_details->subtotal_unformatted * $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol )}}
				...
				@if(!empty($receipt_details->total_exempt_uf))
					<tr>
						...
						<td class="text-right">
							{{format_currency($receipt_details->total_exempt_uf* $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol )}}
						</td>
					</tr>
				@endif
				<!-- Shipping Charges -->
				@if(!empty($receipt_details->shipping_charges))
					<tr>
						...
						<td class="text-right">
							{{format_currency($receipt_details->foreign_shipping_charges * $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol )}}
						</td>
					</tr>
				@endif
				...
				@if(!empty($receipt_details->packing_charge))
					<tr>
						...
						<td class="text-right">
							{{format_currency($receipt_details->packing_charge * $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol )}}
						</td>
					</tr>
				@endif
				...
				@if( !empty($receipt_details->discount) )
					<tr>
						...
						<td class="text-right">
							(-) {{format_currency($receipt_details->foreign_discount * $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol )}}
						</td>
					</tr>
				@endif
				...
				@if( !empty($receipt_details->additional_expenses) )
					@foreach($receipt_details->additional_expenses as $key => $val)
						<tr>
							...
							<td class="text-right">
								(+) {{format_currency(floatval(explode(' ',$val )[1]) * $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol )}}
							</td>
						</tr>
					@endforeach
				@endif
				...
				@if( !empty($receipt_details->tax) )
					<tr>
						...
						<td class="text-right">
							(+) {{format_currency($receipt_details->foreign_tax * $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol )}}
						</td>
					</tr>
				@endif
				...
				<tr>
					...
					<td class="text-right">
						{{format_currency($receipt_details->foreign_total * $receipt_details->foreign_currency->rate,$receipt_details->foreign_currency->symbol )}}
			...
			<table class="table table-slim">
				...
				@if( !empty($receipt_details->total_line_discount) )
					<tr>
						...
						<td class="text-right">
						    <!--{{ $line['total_line_discount'] }}-->{{$receipt_details->total_line_discount}}
						</td>
					</tr>
				@endif
