	...
	<table class="table-pdf td-border">
		...
		@foreach($purchase->purchase_lines as $purchase_line)
			<tr @if($loop->iteration % 2 !== 0) class="odd" @endif style="border:hidden;">
				...
				<td>
					{{format_currency($purchase_line->purchase_price,$currency_details->symbol)}}
				</td>
				<td>
					@php 
		            ...
		            @endphp
		            {{format_currency(($purchase_line->quantity * $purchase_line->purchase_price),$currency_details->symbol)}}
				</td>
			</tr>
		...
		<tr>
			...
			<td colspan="3">
				...
				{{$invoice_layout->total_label}} : {{format_currency($purchase->final_total,$currency_details->symbol)}}
			</td>
		</tr>
		<tr>
			<td colspan="6">
