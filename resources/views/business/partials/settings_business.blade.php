<div class="pos-tab-content active">
    <div class="row">
        ...
        <!--<div class="col-sm-4">-->
        <!--    <div class="form-group">-->
        <!--        {!! Form::label('currency_exchange_rate', __('business.currency_exchange_rate') . ':*') !!} @show_tooltip(__('tooltip.currency_exchange_rate'))-->
        <!--        <div class="input-group">-->
        <!--            <span class="input-group-addon">-->
        <!--                <i class="fa fa-plus-circle"></i>-->
        <!--            </span>-->
        <!--            {!! Form::text('currency_exchange_rate', @num_format($business->currency_exchange_rate), ['class' => 'form-control input_number']); !!}-->
        <!--        </div>-->
        <!--    </div>-->
        <!--</div>-->
        <div class="col-md-4">
