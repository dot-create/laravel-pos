    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="form-group">
            ...
            <label>
                {!! Form::checkbox('rop', 1, !empty($duplicate_product) ? $duplicate_product->enable_stock : false, ['class' => 'input-icheck', 'id' => 'rop']); !!} <strong>@lang('Automatic ROP?')</strong>
            </label>
        </div>
        </div>
            ...
            <div class="col-sm-4 @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" id="stock_type_div">
                <div class="form-group">
                    ...
                    <select class="form-control" name="stock_type">
                        ...
                        <option value="non_stock" selected>Non Stock Product</option>
                    </select>
                </div>
            </div>
        <div class="clearfix"></div>
