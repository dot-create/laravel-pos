           ...
           <!-- Custom Tabs -->
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    @can('stock_report.view')
                        <li>
                            <a href="#product_stock_report" class="product_non_stock_report" data-toggle="tab" aria-expanded="true"><i class="fa fa-hourglass-half" aria-hidden="true"></i> @lang('No Stock Products')</a>
                        </li>
                    @endcan
                </ul>
...
<div id="tab-loading" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(255, 255, 255, 0.7); z-index: 1050; justify-content: center; align-items: center; text-align: center;">
    <div style="margin: auto; color: #333;">
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
            ...
            $('#tab-loading').css('display', 'flex').hide().fadeIn(300);
                    ...
                    stock_report_table = $('#stock_report_table').DataTable({
                        ...
                        ajax: {
                            ...
                            data: function(d) {
                                ...
                                if($('.product_non_stock_report').closest('li').hasClass('active')){
                                    d.stock_type='non_stock';
                                }else{
                                    d.stock_type='stock';
                                }
                            }
                        ...
                        fnDrawCallback: function(oSettings) {
                            ...
                            $('#tab-loading').fadeOut(300); // Hide loading on draw
                        },
