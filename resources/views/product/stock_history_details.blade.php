	...
	<div class="col-md-4 col-xs-4">
		...
		<table class="table table-condensed">
			<tr>
				...
				<td>
					<span class="display_currency" data-is_quantity="true">{{max(0,$stock_details['current_stock'])}}</span> {{$stock_details['unit']}}
				</td>
			</tr>
			<tr>
				<th>@lang('request.intrasit')</th>
				<td>
					<span class="display_currency" data-is_quantity="true">{{$intransitQuantity}}</span>{{$stock_details['unit']}}
				</td>
			</tr>
			<tr>
				<th>@lang('request.commited')</th>
				<td>
					<span class="display_currency" data-is_quantity="true">{{$totalCommitedQty}}</span>{{$stock_details['unit']}}
				</td>
			</tr>
			<tr>
				<th>@lang('request.ipr')</th>
				<td>
					<span class="display_currency" data-is_quantity="true">{{$iprQty}}</span> {{$stock_details['unit']}}
				</td>
			</tr>
			<tr>
				<th>@lang('request.avalibilityQty')</th>
				<td>
					<span class="display_currency" data-is_quantity="true">{{$avaliabilityQty}}</span> {{$stock_details['unit']}}
				</td>
			</tr>
