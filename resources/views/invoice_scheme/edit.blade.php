      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::number('invoice_count', $invoice->invoice_count, [
                'class' => 'form-control', 
                'required', 
                'min' => 1, 
                'id' => 'invoice_count'
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::number('start_number', $invoice->start_number, [
                'class' => 'form-control', 
                'required', 
                'min' => 0, 
                'id' => 'start_number'
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              {!! Form::number('end_number', $invoice->end_number, [
                  'class' => 'form-control', 
                  'readonly' => true, 
                  'id' => 'end_number'
              ]); !!}
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::date('start_date', $invoice->start_date, [
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::date('expiration_date', $invoice->expiration_date, [
                'class' => 'form-control datepicker'
            ]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            {!! Form::text('invoicing_key', $invoice->invoicing_key, [
                'class' => 'form-control', 
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::text('prefix', $invoice->prefix, [
                'class' => 'form-control', 
