...
return [
    ...
    */
    ...
    'new_notification_count_interval' => 10, //Interval to check for new notifications in seconds;Default is 60sec
    ...
    'reset_database' => false //Experimental feature, may depreciate
];
